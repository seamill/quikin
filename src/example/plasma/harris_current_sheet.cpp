#include "harris_current_sheet.h"
...
//    const double Te_Ti = 1.0;
    ...
    qk::grid::rectilinear grid;
    {
        ...
        const double startxs[] = {-Lx/2.};
        const double widths[] = {Lx};
...
//
//
//std::cout << "dt = " << time_dt << std::endl;
//
//    qk::solver::print electrons_rhs_printer;
//    electrons_rhs_printer.add_input_variable(electrons[4]);
//
//    qk::solver::print ions_rhs_printer;
//    ions_rhs_printer.add_input_variable(ions[4]);
//
//    qk::solver::print field_rhs_printer;
//    field_rhs_printer.add_input_variable(fields[4]);
//
